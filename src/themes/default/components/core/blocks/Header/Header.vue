<template>
  <div class="header">
    <header
      class="fixed w-full border-b-1 bg-cl-primary brdr-cl-secondary"
      :class="{ 'is-visible': navVisible }"
    >
      <div class="container px-5">
        <div class="row flex justify-between" v-if="!isCheckoutPage || isThankYouPage">
          <div class="w-1/2 md:w-1/4 self-center">
            <div>
          ...
          <div class="w-2/12 md:w-1/4 self-center">
