<template>
  <div id="home" class="container">
    ...
    <div class="bg-brand-dark w-full h-50 text-brand-light mb-2 md:mb-4 p-5">I am a great big box</div>
    <div class="bg-brand-dark w-full h-50 text-brand-light p-5">I am a (smaller) great big box</div>
  </div>
</template>
